...
| `README.md` · `DISTRIBUTION-MODEL.md` · `TLDR.md` · `GOALS.md` | Human-facing docs. README and DISTRIBUTION-MODEL still describe the previous design and are queued for Stage C of `PLAN.md`; `GOALS.md` is the live statement of values and scenarios |
