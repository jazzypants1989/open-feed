...
| `HANDOFF.md` | **Open work, read this first.** Unfinished items and their context, including one spec rule that no script proves. Delete the file when its jobs are done |
