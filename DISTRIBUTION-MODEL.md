...
/public
  /mom.pence.family          # One document root per member subdomain
    ...
    /feed/items/{hash}.json  # Each committed revision on its own (optional, spec §7.6)
