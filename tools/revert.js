...
const M = [
  ...
  ["the-chain", "src/profile.js",
    "chain.restored && p.chain.length === pin.chain.length + 1",
    "false && p.chain.length === pin.chain.length + 1"],
  ["the-chain", "src/profile.js",
    "const link = p.chain[i], from = p.chain[i - 1].key, recovery = recoveryLists[i];",
  ...
  ["recovery-list", "src/profile.js",
    ...
    "true"],
  ["recovery-list", "src/profile.js",
    "vouches(from, link, recovery) < recovery.k",
    "vouches(from, link, recovery) < 1"],
  ["recovery-list", "src/profile.js",
    "!(j in recoveryLists)",
    "true"],
  // the-index
  ...
  ["padding", "src/envelope.js",
    "policy === 'floor' ? FLOOR : { slots: 1, body: 32 }",
    "policy === 'floor' ? { slots: 1, body: 32 } : { slots: 1, body: 32 }"],
  ["padding", "src/envelope.js",
    "const d = random(56);",
    "const d = random(40);"],
  ["padding", "src/envelope.js",
    "Buffer.alloc(bucket(plain.length + 2, bodyFloor))",
    "Buffer.alloc(bucket(plain.length, bodyFloor))"],
  ["padding", "src/envelope.js",
    "const d = random(56);",
    "const d = Buffer.from(crypto.hkdfSync('sha256', epk, '', String(i), 56));"],
  // moving
  ...
  ["views", "src/views.js",
    ...
    "id: `${loc}/posts/${n}`"],
  ["views", "src/views.js",
    ".filter(([, p]) => p.encrypted === undefined && typeof p.text === 'string')",
  ...
  ["contest", "src/profile.js",
    ...
    "const majority = (from, link, recovery) => vouches(from, link, recovery) >= (recovery?.k ?? Infinity);"],
  ["contest", "src/profile.js",
