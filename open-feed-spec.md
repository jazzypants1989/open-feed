...
- `_next_update`: MAY. Unix seconds, strictly greater than `updated`: the time by which this publisher undertakes to have advanced this chain. It is a **freshness** commitment and the only defence in this specification against a chain that simply stops (§9.2)
