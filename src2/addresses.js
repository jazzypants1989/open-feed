// Address classification for §10's SSRF rule: "reject private/loopback/link-local
// addresses."
//
...
/**
 * The default address policy (spec §10). `fetch.js` applies this to every address DNS
