// The envelope, §7 of open-feed-spec-2.md. Extracted from envelope-gate.js once the construction
// stopped being on trial (the gate proved it; the owner ruled the floor a SHOULD and the carrier
// binding a MUST), so that the gate and tmp/regen2.js share ONE implementation and a vector cannot
...
// The carrier binding (§7.2): the content AEAD's associated data is the ephemeral key and the
